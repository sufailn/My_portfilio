...
export default function Home() {
  return (
    <div className="min-h-screen bg-[#021012] p-8 sm:p-20">
      {/* Header Section */}
      <div className="relative bg-cover bg-center opacity-85 h-96" style={{ backgroundImage: "url('/model_bw.png')" }}>
        <header className="absolute inset-0 flex flex-col items-center justify-center text-center mb-16">
          <h1 className="text-4xl font-bold mb-4 opacity-90 hover:text-white">
        ...
        {"Sufail Ahammed N".split("").map((letter, index) => (
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 hover:text-white">
        Full Stack Developer
          </p>
          <Link className="button" href='https://wa.me/919562026070'>Explore</Link>
        </header>
        <div className="absolute right-5 top-1/2 transform -translate-y-1/2 flex flex-col space-y-4 p-2  rounded-l-lg shadow-lg">
          <a href="https://www.linkedin.com/in/sufail-ahammed-n/" target="_blank" rel="noopener noreferrer" className="hover:text-yellow-500 transition duration-300">
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="https://www.instagram.com/sufail__ahmd" target="_blank" rel="noopener noreferrer" className="hover:text-yellow-500 transition duration-300">
          <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
  ...
  },
{
  ...
  link: "https://www.glidewaymigration.com/"
                  ...
                  <div key={index} className="relative group perspective">
                    <div className="relative w-full h-96 transform-style-preserve-3d transition-transform duration-700 group-hover:rotate-y-180 cursor-pointer">
                    <div className="absolute inset-0 backface-hidden p-4 bg-gray-800 rounded-lg shadow-md flex items-center justify-center" style={{ backgroundImage: `url(${project.image})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
        ...
        <a href="#about-me" className="text-white hover:text-yellow-500 transition duration-300">
