...
export default function ThreeDCardDemo(): JSX.Element {
  const words = [
    { text: "Hi," },
    { text: " ", className: "" }, // Adding space between words
    { text: "I am ", className: "" },
    { text: "Sufail", className: "text-blue-500" },
    { text: " ", className: "" }, // Adding space between words
    { text: "Ahammed", className: "text-blue-500" },
  ];
  return (
    <CardContainer className="inter-var">
      ...
      <p className="text-yellow-500 text-sm max-w-sm mt-2 dark:text-neutral-300">
        ...
        <CardItem translateZ={100} className="w-full mt-4 relative">
          ...
          />
            ...
            <Link 
              className="button flex justify-center items-center absolute inset-0 m-auto px-4 py-2 rounded-md border border-black bg-white text-black text-sm hover:shadow-[4px_4px_0px_0px_rgba(0,0,0)] transition duration-200" 
      ...
      <div className="absolute right-5 mt-10 top-2/3 transform -translate-y-1/2 flex space-x-4 p-2 rounded-l-lg shadow-lg">
        ...
        <a href="https://github.com/sufailn" target="_blank" rel="noopener noreferrer" className="text-black hover:text-yellow-500 transition duration-300">
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
